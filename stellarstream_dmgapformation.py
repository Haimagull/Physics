# -*- coding: utf-8 -*-
"""
This personal project aims to explain to a general public how stellar 
stream's gap formation can be generated by encountering a Dark Matter 
(DM) halo. As it is based on a previous project about Saturn, we use 
Saturn's data for the Milky Way (MW) and adapt every quantity proportionally 
to it, knowing particles densities. The stellar streams corresponding 
to these particle densities are Pal5 for example.
